 ...
 *
 * Supports both 3-segment (`0.41.38`) and 4-segment (`0.42.3.0`) voltmind
 * version strings. The 4th `.MICRO` segment is voltmind's dot-suffix
 ...
 * Accepts both 3-segment (`0.41.38`) and 4-segment (`0.42.3.0`) voltmind versions. */
 ...
 * bumps are deliberately ignored, matching `voltmind check-update`'s
