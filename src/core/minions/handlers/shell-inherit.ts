 ...
 *   - match the `VoltMindConfig` field-name convention
 */
 ...
 * voltmind-flavored names we use a voltmind-prefixed form so they don't collide
 * with provider conventions: `database_url` becomes `VOLTMIND_DATABASE_URL`
