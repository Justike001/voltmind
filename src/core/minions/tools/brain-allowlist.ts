 ...
 * knows brain tools write to the voltmind DB (NOT local files) and to reach
...
export const BRAIN_TOOL_USAGE_HINTS: Readonly<Record<string, string>> = {
  ...
  list_link_sources: 'List link provenance kinds and counts inside the authorized source scope. Use to verify typed citation-graph ingestion mechanically.',
