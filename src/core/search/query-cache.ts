 ...
 * Stale rows are skipped at read time and pruned by `voltmind cache prune`.
 *
...
export class SemanticQueryCache {
    ...
    try {
      ...
      await this.engine.executeRaw(
        `INSERT INTO query_cache (id, query_text, source_id, knobs_hash, embedding, results, meta, ttl_seconds, page_generations, max_generation_at_store, created_at)
         VALUES ($1, $2, $3, $4, $5${cast}, $6::text::jsonb, $7::text::jsonb, $8, $9::text::jsonb, $10, now())
  ...
  /** Summary stats for `voltmind cache stats`. */
