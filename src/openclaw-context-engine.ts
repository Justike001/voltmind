/**
 * OpenClaw plugin entry point for voltmind-context engine.
 *
 ...
 *   plugins.slots.contextEngine: "voltmind-context"
 *
 * @module
 */

/**
 * OpenClaw plugin entry — registers voltmind-context engine.
 *
...
import { createVoltMindContextEngine, ENGINE_ID } from './core/context-engine.ts';
...
const entry: PluginEntry = {
  id: 'voltmind-context-engine',
  name: 'VoltMind Context Engine',
