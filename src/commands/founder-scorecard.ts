/**
 * voltmind founder scorecard <entity-slug> — rolls up Phase 2's typed-claim
 ...
 *
 * Usage:
 *   voltmind founder scorecard companies/acme-example
 *   voltmind founder scorecard companies/acme-example --since 2025-05-17 --until 2026-05-17
 *   voltmind founder scorecard companies/acme-example --json
 */
...
const HELP = `Usage: voltmind founder scorecard <entity-slug> [options]
...
Examples:
  voltmind founder scorecard companies/acme-example
  voltmind founder scorecard companies/acme-example --since 2025-05-17 --json
`;
