 ...
 *   voltmind transcripts recent --days 14
 *   voltmind transcripts recent --full       # full content (capped at 100KB/file)
 *   voltmind transcripts recent --json
 */
...
const HELP = `Usage: voltmind transcripts recent [options]
