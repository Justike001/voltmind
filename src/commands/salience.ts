/**
 * voltmind salience — Pages recently touched, ranked by emotional + activity salience.
 *
 ...
 *
 * Usage:
 *   voltmind salience                            # top 20 over last 14 days
 *   voltmind salience --days 7                   # narrower window
 *   voltmind salience --kind personal            # filter to slug-prefix
 *   voltmind salience --json                     # JSON for agents
 */
...
const HELP = `Usage: voltmind salience [options]
