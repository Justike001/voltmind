/**
 * voltmind anomalies — Statistical anomalies in recent page activity.
 *
 ...
 *
 * Usage:
 *   voltmind anomalies                          # since=today, lookback=30d, sigma=3
 *   voltmind anomalies --since 2026-04-28
 *   voltmind anomalies --sigma 2 --lookback-days 60
 *   voltmind anomalies --json
 */
...
const HELP = `Usage: voltmind anomalies [options]
