...
describe('embedMultimodal — openai-compat routing (#875)', () => {
  ...
  test('D12 — default embedding_dimensions (2048 for the internal Qwen stack) applies when not explicitly set', async () => {
    ...
    // intentionally NO embedding_dimensions → falls back to 2048
