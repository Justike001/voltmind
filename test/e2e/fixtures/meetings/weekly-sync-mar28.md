...
- Ship hybrid search in VoltMind v0.3. This is the highest priority feature.
...
- [ ] Implement pgvector extension and embedding storage in VoltMind schema
- [ ] Build hybrid search with RRF scoring in VoltMind v0.3
...
Productive sync. The VoltMind search discussion was the most substantive — we identified
