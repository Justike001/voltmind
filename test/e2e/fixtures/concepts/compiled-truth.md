...
The two-layer page pattern used throughout VoltMind. Every page has two distinct
...
VoltMind uses retrieval-augmented generation (RAG) to surface relevant pages during
...
Extended the pattern to all VoltMind page types: people, companies, deals, meetings,
