/**
 * E2E for `voltmind eval cross-modal` runner via mocked gateway chat().
 *
...
beforeEach(() => {
  tempDir = mkdtempSync(join(tmpdir(), 'voltmind-cme-e2e-'));
...
describe('voltmind eval cross-modal — runner verdict contract', () => {
