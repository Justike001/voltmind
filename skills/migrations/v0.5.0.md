...
**Read VOLTMIND_SKILLPACK.md Section 18** for the full guide. The short version:
...
New in v0.5.0: `docs/VOLTMIND_VERIFY.md` is a 6-check runbook that catches silent
