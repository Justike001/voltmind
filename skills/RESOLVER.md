...
| Ingest produced local `state/actions/*.md`, schedule pending actions, collect action execution details and exact execution time | `skills/schedule-actions/SKILL.md` (local Markdown first; DB/MCP index is optional) |
