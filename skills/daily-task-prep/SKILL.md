...
3. **Load today's report.** Read and invoke `skills/briefing/SKILL.md` for the
   canonical daily inventory, deadlines, commitments, reconciliation and coverage.
   Reuse already loaded meeting context; do not maintain a separate task inventory.
4. **Compile prep briefing.** Use briefing's current report and add meeting prep
   cards and relevant unresolved threads. Produce one combined report.
