...
|---|---|
| Every user-visible ingest completion, including zero-action and batch runs | [completion-handoff.md](references/completion-handoff.md) |
...
10. **Deliver the ingest receipt.** Read
    [completion-handoff.md](references/completion-handoff.md). Summarize this
    request's evidence, canonical updates, pending questions and sync/receipt
    failures.
