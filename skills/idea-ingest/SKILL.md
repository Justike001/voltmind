...
- Raw source preserved for provenance via `voltmind files upload-raw`
...
2. **Upload raw source.** Save the fetched content for provenance: `voltmind files upload-raw <file> --page <slug>`
