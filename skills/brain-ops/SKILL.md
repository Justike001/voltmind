...
1. `voltmind search "name"` — keyword search for existing pages
2. `voltmind query "natural question about name"` — hybrid search for context
3. `voltmind get <slug>` — if you know the slug, read the full page
