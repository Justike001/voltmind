...
| Weekly | Brain maintenance | `voltmind doctor`, embed stale, orphan detection | [maintain skill](../../skills/maintain/SKILL.md) |
...
dream_cycle():
  ...
  for message in conversations:
    ...
    for entity in entities:
      page = voltmind search "{entity.name}"
      if not page:
  ...
  pages = voltmind list --type person --limit 100
  for page in pages:
...
5. **Health check:** Run `voltmind doctor --json`. All checks should pass.

---

*Part of the [VoltMind Skillpack](../VOLTMIND_SKILLPACK.md). See also: [Quiet Hours](quiet-hours.md), [Operational Disciplines](operational-disciplines.md)*
